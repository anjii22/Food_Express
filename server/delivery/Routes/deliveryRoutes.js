...
//http://delivery-service:3004/api/delivery/availability/:id
router.get("/availability/:id", checkAvailability);

// This route is used to toggle the availability status of a driver
//http://delivery-service:3004/api/delivery/UpdateAvailability/:id
